...
I decided to choose three different test tasks to test my skills. The third of them is [simple react project](https://docs.yandex.ru/docs/view?url=ya-disk-public%3A%2F%2FPg8Mn9b2nwRtbsd79GdjAOk0sK0J5vagJAQzR5a5H4HBf2B6dSCQGd5kCvgXaxdcq%2FJ6bpmRyOJonT3VoXnDag%3D%3D&name=Тестовое%20задание.docx).

*All the commands to run are in the Makefile*  
...
### Link to the result
https://test-task-three-site.vercel.app
